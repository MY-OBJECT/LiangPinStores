...
public class HeadJson {
    ...
    public <T> T parsingObject(String objStr, Class<T> classs) {
        if (error != -1 && !object.isNull(objStr)) {
            GsonUtil gson = new GsonUtil();
