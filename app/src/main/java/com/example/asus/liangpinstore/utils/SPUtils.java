...
public class SPUtils {
     ...
     * 保存在手机里面的文件名
     */
//    public static final String FILE_NAME = "user_id";
     ...
     * @param beUser
     */
    public static void setUser(String fileName, Context context,BeUser.ResultBean.UserInfoBean beUser){
        SharedPreferences sp = context.getSharedPreferences(fileName,
                Context.MODE_PRIVATE);
     ...
     * 获得用户信息
     */
    public static BeUser.ResultBean.UserInfoBean getUser(String fileName,Context context){
        SharedPreferences sp = context.getSharedPreferences(fileName,
                Context.MODE_PRIVATE);
        BeUser.ResultBean.UserInfoBean beUser = new GsonUtil().getJsonObject(sp.getString("user", ""), BeUser.ResultBean.UserInfoBean.class);
        if (beUser != null) return beUser;
        else return new BeUser.ResultBean.UserInfoBean();
    }
