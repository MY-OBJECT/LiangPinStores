package com.example.asus.liangpinstore.db;
...
import com.example.asus.liangpinstore.MyApplication;
    ...
    synchronized public Map<String, EaseUser> getContactList() {
        ...
        if (db.isOpen()) {
            ...
            while (cursor.moveToNext()) {
                ...
                if (username.equals(MyConstants.NEW_FRIENDS_USERNAME) || username.equals(MyConstants.GROUP_USERNAME)
                        || username.equals(MyConstants.CHAT_ROOM)|| username.equals(MyConstants.CHAT_ROBOT)) {
