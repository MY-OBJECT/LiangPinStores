...
import com.example.asus.liangpinstore.db.DemoDBManager;
import com.example.asus.liangpinstore.db.InviteMessgeDao;
import com.example.asus.liangpinstore.db.UserDao;
import com.example.asus.liangpinstore.domain.InviteMessage.InviteMessageStatus;
import com.example.asus.liangpinstore.domain.DemoModel;
import com.example.asus.liangpinstore.domain.InviteMessage;
import com.example.asus.liangpinstore.domain.RobotUser;
import com.example.asus.liangpinstore.ui.activity.ChatActivity;
import com.example.asus.liangpinstore.utils.PreferenceManager;
...
//                    intent = new Intent(appContext, VoiceCallActivity.class);
                    ...
                    if (chatType == ChatType.Chat) { // single chat message
                        ...
                        intent.putExtra("chatType", MyConstants.CHATTYPE_SINGLE);
                    } else { // group chat message
                        // message.getTo() is the group id
                        intent.putExtra("userId", message.getTo());
                        if(chatType == ChatType.GroupChat){
                            intent.putExtra("chatType", MyConstants.CHATTYPE_GROUP);
                        }else{
                            intent.putExtra("chatType", MyConstants.CHATTYPE_CHATROOM);
                        }
        ...
        connectionListener = new EMConnectionListener() {
            ...
            public void onDisconnected(int error) {
                ...
                if (error == EMError.USER_REMOVED) {
                    onUserException(MyConstants.ACCOUNT_REMOVED);
                } else if (error == EMError.USER_LOGIN_ANOTHER_DEVICE) {
                    onUserException(MyConstants.ACCOUNT_CONFLICT);
                } else if (error == EMError.SERVER_SERVICE_RESTRICTED) {
                    onUserException(MyConstants.ACCOUNT_FORBIDDEN);
                } else if (error == EMError.USER_KICKED_BY_CHANGE_PASSWORD) {
                    onUserException(MyConstants.ACCOUNT_KICKED_BY_CHANGE_PASSWORD);
                } else if (error == EMError.USER_KICKED_BY_OTHER_DEVICE) {
                    onUserException(MyConstants.ACCOUNT_KICKED_BY_OTHER_DEVICE);
                }
            }
    ...
    class MyGroupChangeListener implements EMGroupChangeListener {
        ...
        public void onInvitationReceived(String groupId, String groupName, String inviter, String reason) {
            ...
            broadcastManager.sendBroadcast(new Intent(MyConstants.ACTION_GROUP_CHANAGED));
        }
    ...
    public class MyContactListener implements EMContactListener {
        ...
        public void onContactAdded(String username) {
            ...
            broadcastManager.sendBroadcast(new Intent(MyConstants.ACTION_CONTACT_CHANAGED));
    	...
    	messageListener = new EMMessageListener() {
            ...
            public void onMessageRecalled(List<EMMessage> messages) {
                for (EMMessage msg : messages) {
                    ...
                    msgNotification.setAttribute(MyConstants.MESSAGE_TYPE_RECALL, true);
